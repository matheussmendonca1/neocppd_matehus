...
<html lang="en">
  <head>
    ...
    <link href="<?= base_url() ?>css/governo.css" rel="stylesheet" >
    ...
    <div id="barra-brasil" style="background:#7F7F7F; height: 20px; padding:0 0 0 10px;display:block;"> 
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div id="logo" class="col-lg-9 small">
                        <a href="<?= base_url()?>" title="Campus Inconfidentes">
        ...
        <div class="container">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url("home/documentos") ?>">Documentos</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url("home/tabelas") ?>">Tabelas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url("home/progressao") ?>">Progressão e Aceleração</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url("home/afastamento") ?>">Afastamento para capacitação</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url("home/rsc") ?>">RSC</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url("home/normativa") ?>">Normativa Docente</a>
                </li>
                <li class="nav-item">
