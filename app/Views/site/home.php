...
<div class="row justify-content-center">
  ...
  <br>
      ...
      <div class="col-lg-8">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="<?= base_url() ?>img/CPPD.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="<?= base_url() ?>img/campus.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="<?= base_url() ?>img/campus2.jpeg" class="d-block w-100" alt="..." alt="...">
          </div>
        </div>
    ...
    <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example">
      <h2 id="list-item-1">Comissão Permanente de Pessoal Docente (CPPD)</h2><hr>
      ...
      <h2 id="list-item-2">Documentos</h2><hr>
        <h4><a class="nav-link" href="<?= base_url() ?>documentos/Lei_12.772.pdf" target="_blank">Lei no 12.772, de 28 de dezembro de 2012.</a></h4>
        <h4><a class="nav-link" href="<?= base_url() ?>documentos/Reg_60_2019_CPPD.pdf" target="_blank">Resolução no 060/2019, de 29 de agosto de 2019.</a></h4>
